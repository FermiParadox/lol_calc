...
ITEMS_ATTRIBUTES = {
    'dorans_blade': {'buffs': {},
                     ...
                     'secondary_data': {'build_from': {},
                                        ...
                                        'total_price': 440},
                     'unique_stats': {}},
    'dorans_shield': {'buffs': {'dorans_shield_buff_0': {'buff_source': 'dorans_shield',
                                                         'dot': False,
                                                         'duration': 'permanent',
                                                         'max_stacks': 1,
                                                         'on_hit': None,
                                                         'stats': {'flat_non_aoe_reduction': {'additive': {'stat_mods': {},
                                                                                                           'stat_values': 8}},
                                                                   'hp5': {'additive': {'stat_mods': {},
                                                                                        'stat_values': 6}}},
                                                         'target_type': 'player'}},
                      'dmgs': {},
                      'general_attributes': {'castable': False},
                      ...
                      'secondary_data': {'build_from': {},
                                         ...
                                         'sell_price': 176,
                                         'total_price': 440},
                      'unique_stats': {'additive': {'hp': 6}}},
    'hextech_gunblade': {'buffs': {'hextech_gunblade_slow': {'buff_source': 'hextech_gunblade',
                                                             'dot': False,
                                                             'duration': 2,
                                                             'max_stacks': 1,
                                                             'on_hit': None,
    ...
    'dorans_blade': {'enemy': {'actives': {'buffs': [],
                     ...
                     'player': {'actives': {'buffs': [],
                                ...
                                'passives': {'buffs': [],
                                             'dmg': [],
                                             'remove_buff': []}}},
    'dorans_shield': {'enemy': {'actives': {'buffs': [],
                                            'dmg': [],
                                            'remove_buff': []},
                                'passives': {'buffs': [],
                                             'dmg': [],
                      ...
                      'player': {'actives': {'buffs': [],
                                             'dmg': [],
                                             'remove_buff': []},
                                 'passives': {'buffs': ['dorans_shield_buff_0'],
                                              'dmg': [],
                                              'remove_buff': []}}},
