    ...
    'buffs': {'e_dmg_red': {'dot': False,
              ...
              'r_nth_hit_buff': {'buff_source': 'r',
                                 ...
                                 'every_nth_hit': {
                                     ...
                                     'counter_duration': 3,
                                     'stacks_per_hit': 1,
                                     'stacks_per_movement_unit': 0,
                                     'reset_on_aa_target_change': False
                                 }},
              'w_buff_0': {'buff_source': 'w',
                           'dot': False,
                           'duration': 7,
                           'max_stacks': 1,
                           'max_targets': 1,
...
ABILITIES_EFFECTS = {
    'inn': {'actives': {},
            'passives': {'buffs': ['inn_att_speed_initiator'],
                         'dmg': [],
                         'remove_buff': []}},
    'q': {'actives': {'buffs': [],
                      'dmg': ['q_dmg_0'],
    ...
    'w': {'actives': {'buffs': ['w_buff_0'], 'dmg': [], 'remove_buff': []},
          'passives': {'buffs': [], 'dmg': [], 'remove_buff': []}},
    'e': {'actives': {'buffs': ['e_dmg_red'],
                      'dmg': ['e_dmg_0'],
                      'remove_buff': []},
          'passives': {'buffs': [], 'dmg': [], 'remove_buff': []}},
    'r': {'actives': {'buffs': ['r_dmg_red'],
                      'dmg': [],
                      'remove_buff': []},
          'passives': {'buffs': ['r_nth_hit_buff'],
                       'dmg': [],
                       'remove_buff': []}}}
...
ABILITIES_CONDITIONALS = {
    'q_apply_w_conditional': {'effects': {'apply_w_dmg': {'obj_name': 'q',
                                          ...
                                          'remove_w_buff': {'obj_name': 'q',
                                                            ...
                                                            'mod_operation': 'append',
                                                            'names_lst': ['w_buff_0']}},
                              'triggers': {'q_while_w_trig': {'buff_name': 'w_buff_0',
                                                              'operator': '==',
                                                              'owner_type': 'player',
                                                              'stacks': 1,
                                                              'trigger_type': 'buff'}}}}
