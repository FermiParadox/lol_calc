ABILITIES_ATTRIBUTES = {
    'buffs': {'e_dmg_red': {'stats': {'aoe_dmg_reduction': {'percent': {'stat_values': 0.25,
              ...
              'inn_att_speed_buff': {'stats': {'att_speed': {'percent': {'stat_values': (0.04, 0.06, 0.08, 0.10, 0.12),
                                     ...
                                     'target_type': 'player',
                                     'dot': False},
              'inn_att_speed_initiator': {'stats': None,
                                          'buff_source': 'inn',
                                          'duration': 'permanent',
                                          'max_stacks': 1,
                                          'on_hit': {'cause_dmg': [],
                                                     'apply_buff': ['inn_att_speed_buff'],
                                                     'reduce_cd': {},
                                                     'remove_buff': []},
                                          'prohibit_cd_start': None,
                                          'target_type': 'player',
    ...
    'dmgs': {'e_dmg_0': {'delay': None,
             ...
             'q_dmg_0': {'delay': None,
                         ...
                         'max_targets': 1,
                         'mods': {'enemy': {},
                                  'player': {'ap': {'additive': 0.6}, 'bonus_ad': {'additive': 1.0}}},
                         'radius': None,
                         'target_type': 'enemy',
                         'usual_max_targets': 1,
                         'resource_type': 'hp'},
             'r_dmg_0': {'delay': None,
                         ...
                         'life_conversion_type': 'spellvamp',
                         'max_targets': 1,
                         'mods': {'enemy': {}, 'player': {'ap': {'additive': 0.7}}},
                         'radius': None,
                         'target_type': 'enemy',
                         'usual_max_targets': 1,
                         'resource_type': 'hp'},
             'w_dmg_0': {'delay': None,
                         ...
                         'life_conversion_type': 'spellvamp',
                         'max_targets': 1,
                         'mods': {'enemy': {}, 'player': {'ap': {'additive': 0.6}}},
                         'radius': None,
                         'target_type': 'enemy',
                         'usual_max_targets': 1,
                         'resource_type': 'hp'}},
