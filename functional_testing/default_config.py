...
# Probable bug with mana. (displays increase without cause; might be old cost/regen being applied later than a new one)
DATA_1 = dict(
    ...
    rotation_lst=[],
    chosen_items_dct={'player': ['blade_of_the_ruined_king', 'trinity_force', 'youmuus_ghostblade',
                                 'bamis_cinder', 'the_black_cleaver'],
                      'enemy_1': ['blade_of_the_ruined_king', 'chain_vest', 'chain_vest'],
                      'enemy_2': ['dorans_shield', 'blade_of_the_ruined_king'],
                      'enemy_3': ['dorans_shield', 'blade_of_the_ruined_king'], },
    initial_enemies_total_stats=None,
